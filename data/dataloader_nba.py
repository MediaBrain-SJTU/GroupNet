...
class NBADataset(Dataset):
    ...
    def __init__(
        ...
        if training:
            data_root = '/GPFS/data/cxxu/trajectory_prediction/AgentFormer/datasets/nba/train.npy'
        else:
            data_root = '/GPFS/data/cxxu/trajectory_prediction/AgentFormer/datasets/nba/test.npy'
